...
- [`chain_spec.rs`](noderc/chain_spec.rs): A [chain
...
- [`service.rs`](noderc/service.rs): This file defines the node
...
Review the [FRAME runtime implementation](runtimerc/lib.rs) included in this
...
`pallets`](palletsemplate/src/lib.rs) directory.
