...
parameter_types! {
    ...
    pub const BasicDeposit: Balance = 1 * 1000;
    pub const ByteDeposit: Balance =  1000;
    pub const SubAccountDeposit: Balance = 2 * 1000;   // 53 bytes on-chain
...
impl pallet_society::Config for Runtime {
    ...
    type FounderSetOrigin = EnsureRoot<Self::AccountId>;
...
parameter_types! {
    ...
    // pub const EPOCH_DURATION_IN_BLOCKS: u32 = 200;
