use super::super::pallet_index::pallet_index::BAGS_LIST;
...
impl PalletBagsListConfig {
    pub fn new() -> Self {
        ...
        let runtime = PalletRuntimeConfig {
            ...
            pallet_traits: vec![
                (
                    PalletBagsListTraits::RuntimeEvent.to_string(),
                    "RuntimeEvent".to_string(),
                ),
                (
                    PalletBagsListTraits::ScoreProvider.to_string(),
                    "Staking".to_string(),
                ),
                (
                    PalletBagsListTraits::BagThresholds.to_string(),
                    "BagThresholds".to_string(),
                ),
                (
                    PalletBagsListTraits::Score.to_string(),
                    "VoteWeight".to_string(),
                ),
                (
                    PalletBagsListTraits::WeightInfo.to_string(),
                    "pallet_bags_list::weights::SubstrateWeight<Runtime>".to_string(),
                ),
            ]
            .into_iter()
            .collect(),
